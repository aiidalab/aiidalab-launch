...
setup(
    ...
    description="Helper script to launch AiiDAlab on a local workstation.",
    ...
    entry_points="""
    [console_scripts]
    aiidalab-launch=aiidalab_launch.cli:cli
    """,
    ...
    url= 'https://github.com/csadorf/aiidalab_launch',
    download_url=(
        f'https://github.com/csadorf/'
        f'aiidalab_launch/archive/{version}.tar.gz'
    ),
    keywords=[
